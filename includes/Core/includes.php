...
wp_enqueue_style('nex-forms-animate', plugins_url( '/css/animate.css',dirname(dirname(__FILE__))));
//JQUERY UI
...
wp_enqueue_script('nex-forms-wow',  plugins_url( '/js/wow.min.js',dirname(dirname(__FILE__))));
