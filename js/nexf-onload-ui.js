...
jQuery(document).on('click', '.bootstrap-select li', function(){			
...
function()
	...
	jQuery(document).on('keyup keypress', '#nex-forms form input[type="text"], #nex-forms form textarea', function(e) {
	  if(e.which == 13) {
		e.preventDefault();
		return false;
	  }
